...
export function Content() {
  ...
  const baseURL = 'https://beck-end-mahk.onrender.com/mulheres'
  ...
  return (
    <>
      <Header
        ...
        subtitle='Exemplos de coragem e inspiração para todas as gerações'
        image={listaImg}
      />
      ...
      <div >
        <h2 className={styles.projectsTitle}>Cadastre uma diva inspiradora:</h2>
